...
@Component({
  selector: 'app-editor-hud',
  templateUrl: './editor-hud.component.html',
  styleUrls: ['./editor-hud.component.css']
})
export class EditorHudComponent implements OnInit, OnDestroy {
